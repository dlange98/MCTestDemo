...
let AppCreateCommand = class AppCreateCommand extends commandline_1.Command {
    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createAppResponse = yield interaction_1.out.progress("Creating app ...", apis_1.clientRequest((cb) => client.apps.create(appAttributes, cb)));
...
__decorate([
    commandline_1.help("The OS the app will be running on. Supported values: Android, iOS, Windows"),
...
__decorate([
    commandline_1.help("The platform of the app. Supported values: Java, Objective-C-Swift, React-Native, UWP, Xamarin"),
