...
let SetCurrentAppCommand = class SetCurrentAppCommand extends commandline_1.Command {
    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const apps = yield interaction_1.out.progress("Reading available apps...", apis_1.clientCall((cb) => client.apps.list(cb)));
...
SetCurrentAppCommand = __decorate([
    commandline_1.help("Set default application for all CLI commands")
