...
let DownloadBuildStatusCommand = DownloadBuildStatusCommand_1 = class DownloadBuildStatusCommand extends commandline_1.AppCommand {
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield interaction_1.out.progress("Creating destination folder... ", Pfs.mkdirp(this.directory));
            let outputPath;
    ...
    unpackAndWriteDirectory(directoryZip, extension, sourceBranch, root) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Pfs.mkdirp(directoryPath);
            yield JsZipHelper.unpackZipToPath(directoryPath, directoryZip, root);
            return directoryPath;
        });
    }
};
DownloadBuildStatusCommand.applicationPackagesExtensions = [".apk", ".ipa", ".xcarchive"];
...
__decorate([
    commandline_1.help("Download destination path"),
