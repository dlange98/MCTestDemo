...
const release_command_skeleton_1 = require("./lib/release-command-skeleton");
...
let CodePushReleaseCordovaCommand = class CodePushReleaseCordovaCommand extends release_command_skeleton_1.default {
    run(client) {
