...
class SymbolsUploadingHelper {
    ...
    uploadSymbolsZip(zip) {
        return __awaiter(this, void 0, void 0, function* () {
            // executing API request to get an upload URL
            const uploadingBeginRequestResult = yield this.executeSymbolsUploadingBeginRequest(this.client, this.app);
            // uploading
            ...
            try {
                ...
                yield new azure_blob_upload_helper_1.default(this.debug).upload(uploadUrl, zip);
    ...
    executeSymbolsUploadingBeginRequest(client, app) {
        return __awaiter(this, void 0, void 0, function* () {
            this.debug("Executing API request to get uploading URL");
            const uploadingBeginResponse = yield apis_1.clientRequest((cb) => client.symbolUploads.create({ symbolType: "Apple" }, // Temporary hard coding until type is threaded through the commands
            app.ownerName, app.appName, cb)).catch((error) => {
