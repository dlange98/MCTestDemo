...
let UploadSymbols = class UploadSymbols extends commandline_1.AppCommand {
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // upload symbols
            yield interaction_1.out.progress("Uploading symbols...", new symbols_uploading_helper_1.default(client, app, debug).uploadSymbolsZip(pathToZipToUpload));
        ...
        if (fsEntryStats.isDirectory()) {
            ...
            switch (this.getLowerCasedFileExtension(filePath)) {
                ...
                default:
                    ...
                    return subfolder_symbols_helper_1.getChildrenDsymFolderPaths(filePath, debug).length > 0 ? SymbolFsEntryType.DsymParentFolder : SymbolFsEntryType.Unknown;
            }
        }
    ...
    validateParameters() {
        ...
        if (_.isNil(this.symbolsPath) && _.isNil(this.xcarchivePath)) {
            throw commandline_2.failure(commandline_2.ErrorCodes.InvalidParameter, "specify either '--symbol' or '--xcarchive' switch");
        }
        else if (!_.isNil(this.symbolsPath) && !_.isNil(this.xcarchivePath)) {
            throw commandline_2.failure(commandline_2.ErrorCodes.InvalidParameter, "'--symbol' and '--xcarchive' switches are mutually exclusive");
        }
    }
