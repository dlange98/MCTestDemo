...
let ReleaseBinaryCommand = class ReleaseBinaryCommand extends commandline_1.AppCommand {
    ...
    distributeRelease(client, app, releaseId, releaseNotesString) {
        return __awaiter(this, void 0, void 0, function* () {
            let updateReleaseRequestResponse;
            try {
                updateReleaseRequestResponse = yield interaction_1.out.progress(`Distributing the release...`, apis_1.clientRequest((cb) => __awaiter(this, void 0, void 0, function* () {
                    return client.releases.update(releaseId, {
