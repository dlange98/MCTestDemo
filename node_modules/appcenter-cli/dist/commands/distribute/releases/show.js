    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const httpRequest = yield interaction_1.out.progress("Loading release details...", apis_1.clientRequest((cb) => client.releases.getLatestByUser(this.releaseId, app.ownerName, app.appName, cb)));
            ...
            interaction_1.out.report([
                ...
                ["Icon URL", "appIconUrl"],
                ["Distribution Group", "distributionGroups", (distributionGroups) => _.get(distributionGroups, "[0].name", "")]
            ], releaseDetails);
