...
const AppCenterClient = require("./generated/appCenterClient");
...
function createAppCenterClient(command, telemetryEnabled) {
    ...
    return {
        ...
        fromToken(token, endpoint) {
            ...
            return new AppCenterClient(new appcenter_client_credentials_1.AppCenterClientCredentials(tokenFunc), endpoint, createClientOptions());
        },
        fromProfile(user) {
            if (!user) {
            ...
            return new AppCenterClient(new appcenter_client_credentials_1.AppCenterClientCredentials(() => user.accessToken), user.endpoint, createClientOptions());
        }
    };
}
